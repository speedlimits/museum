...
template = """%s <script type="text/javascript"> top.window.postMessage("%s", "*"); </script>"""

def saveMuseum(title, description, data):
	wp = WordPress('http://www.dennisschaaf.com/bornholm/xmlrpc.php','bornholm_museum','4154184042')
	wp.new_post({'title':title,
		 'description':template % (description,data) + '', 
		 'mt_excerpt':description, 'categories': ['Museum']})

def main():
	saveMuseum('python based save', 'this set of data was saved using pythons xmlrpc script and loads properly', '')
